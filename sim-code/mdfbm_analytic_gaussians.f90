...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
      ...
      real(r8b), parameter        :: GAMMA = 2.0D0 - 1.0D0              ! FBM correlation exponent 
      ...
      real(r8b)                   :: force_weight = -0.025D0        ! multiplied against density gradient (negative as repelled by density)
      ...
      integer(i4b), parameter     :: NBIN =  INT(5.0D0 * L)                   ! number of bins for density distribution
